...
class Homepage extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('homepage_section_2_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('homepage_section_2_main_heading','homepage_section_2_sub_heading','homepage_section_2_paragraph','homepage_section_2_button_text','homepage_section_2_background_image','homepage_section_3_main_heading','homepage_section_3_paragraph','homepage_section_4_main_heading','homepage_section_4_paragraph','homepage_section_6_main_heading','homepage_section_6_paragraph','homepage_section_7_main_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'homepage_section_2_main_heading' => $this->input->post('homepage_section_2_main_heading',TRUE),
				'homepage_section_2_sub_heading' => $this->input->post('homepage_section_2_sub_heading',TRUE),
				'homepage_section_2_paragraph' => $this->input->post('homepage_section_2_paragraph',TRUE),
				'homepage_section_2_button_text' => $this->input->post('homepage_section_2_button_text',TRUE),
				'homepage_section_2_background_image' => $this->input->post('homepage_section_2_background_image',TRUE),
				'homepage_section_3_main_heading' => $this->input->post('homepage_section_3_main_heading',TRUE),
				'homepage_section_3_paragraph' => $this->input->post('homepage_section_3_paragraph',TRUE),
				'homepage_section_4_main_heading' => $this->input->post('homepage_section_4_main_heading',TRUE),
				'homepage_section_4_paragraph' => $this->input->post('homepage_section_4_paragraph',TRUE),
				'homepage_section_6_main_heading' => $this->input->post('homepage_section_6_main_heading',TRUE),
				'homepage_section_6_paragraph' => $this->input->post('homepage_section_6_paragraph',TRUE),
				'homepage_section_7_main_heading' => $this->input->post('homepage_section_7_main_heading',TRUE),
