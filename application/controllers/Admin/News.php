...
class News extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('news_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('news_title','news_description','news_image','news_publish',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				...
				'news_author_name' => $this->input->post('news_author_name',TRUE),
				'news_publish' => $this->input->post('news_publish',TRUE),
