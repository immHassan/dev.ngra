...
class Customer extends Admin_Controller {
    function __construct() {
        ...
        $this->orderable = true;  
        $this->show_fields = array('customer_name','customer_email','customer_gender','customer_phone','customer_address','user_image',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				...
				'user_rest_token' => $this->input->post('user_rest_token',TRUE),
