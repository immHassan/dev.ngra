...
class Asset extends Admin_Controller {
    function __construct() {
        ...
        $this->orderable = true;  
        $this->show_fields = array('asset_tag','asset_tag_property','asset_tag_property_value','asset_tag_type','asset_tag_inner_value',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				...
				'asset_tag_property' => $this->input->post('asset_tag_property',TRUE),
				'asset_tag_property_value' => $this->input->post('asset_tag_property_value',TRUE),
				'asset_tag_type' => $this->input->post('asset_tag_type',TRUE),
				'asset_tag_inner_value' => $this->input->post('asset_tag_inner_value',TRUE),
