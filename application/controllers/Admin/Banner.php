...
class Banner extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('banner_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('banner_heading','banner_paragraph','banner_button_text','banner_button_color','banner_image',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				...
				'banner_paragraph' => $this->input->post('banner_paragraph',TRUE),
				'banner_button_text' => $this->input->post('banner_button_text',TRUE),
				'banner_button_color' => $this->input->post('banner_button_color',TRUE),
