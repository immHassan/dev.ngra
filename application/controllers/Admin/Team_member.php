...
class Team_member extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('team_member_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('team_member_name','team_member_designation','team_member_dob','team_member_image','team_member_location',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'team_member_name' => $this->input->post('team_member_name',TRUE),
				'team_member_designation' => $this->input->post('team_member_designation',TRUE),
				'team_member_dob' => $this->input->post('team_member_dob',TRUE),
				'team_member_image' => $this->input->post('team_member_image',TRUE),
				'team_member_location' => $this->input->post('team_member_location',TRUE),
