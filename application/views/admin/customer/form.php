        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('customer_name','text','required',$record)?>
										 <?php echo form_item('customer_email','text','required',$record)?>
										 <?php echo form_item('customer_gender','option','required',$record,array('male'=>'male','female'=>'female'))?>
										 <?php echo form_item('customer_phone','text','not-required',$record)?>
										 <?php echo form_item('customer_address','textarea','not-required',$record)?>
										 <?php echo form_item('user_image','image','required',$record)?>
