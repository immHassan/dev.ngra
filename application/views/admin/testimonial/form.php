        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('testimonial_title','text','required',$record)?>
										 <?php echo form_item('testimonial_description','text','required',$record)?>
										 <?php echo form_item('testimonial_name','text','required',$record)?>
										 <?php echo form_item('testimonial_image','image','required',$record)?>
