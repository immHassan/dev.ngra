        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('footer_address','text','required',$record)?>
										 <?php echo form_item('footer_phone','text','required',$record)?>
										 <?php echo form_item('footer_email','text','required',$record)?>
