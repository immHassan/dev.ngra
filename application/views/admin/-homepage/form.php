        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('homepage_news_heading','text','required',$record)?>
										 <?php echo form_item('homepage_news_paragraph','textarea','required',$record)?>
										 <?php echo form_item('homepage_team_heading','text','required',$record)?>
										 <?php echo form_item('homepage_team_paragraph','textarea','required',$record)?>
										 <?php echo form_item('homepage_gallery_heading','text','required',$record)?>
										 <?php echo form_item('homepage_gallery_paragraph','textarea','required',$record)?>
										 <?php echo form_item('homepage_shop_heading','text','required',$record)?>
