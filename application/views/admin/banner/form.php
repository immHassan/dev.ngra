        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('banner_heading','text','required',$record)?>
										 <?php echo form_item('banner_paragraph','textarea','required',$record)?>
										 <?php echo form_item('banner_button_text','text','required',$record)?>
										 <?php echo form_item('banner_button_color','text','required',$record)?>
										 <?php echo form_item('banner_image','image','required',$record)?>
