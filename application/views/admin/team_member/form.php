        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('team_member_name','text','required',$record)?>
										 <?php echo form_item('team_member_designation','text','required',$record)?>
										 <?php echo form_item('team_member_dob','text','required',$record)?>
										 <?php echo form_item('team_member_image','image','required',$record)?>
										 <?php echo form_item('team_member_location','textarea','required',$record)?>
