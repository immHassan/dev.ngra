        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('news_title','textarea','required',$record)?>
										 <?php echo form_item('news_description','textarea_editor','required',$record)?>
										 <?php echo form_item('news_image','image','required',$record)?>
										 <?php echo form_item('news_slug','text','required',$record)?>
										 <?php echo form_item('news_author_name','text','not-required',$record)?>
										 <?php echo form_item('news_publish','text','required',$record)?>
