        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('asset_tag','text','required',$record)?>
										 <?php echo form_item('asset_tag_property','text','required',$record)?>
										 <?php echo form_item('asset_tag_property_value','text','required',$record)?>
										 <?php echo form_item('asset_tag_type','text','required',$record)?>
										 <?php echo form_item('asset_tag_inner_value','text','required',$record)?>
